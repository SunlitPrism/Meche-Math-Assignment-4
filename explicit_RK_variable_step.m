%This function computes the value of X at the next time step for any arbitrary embedded RK method
%also computes the next step size to use, and whether or not to accept/reject the projected value of X(t+h) (for variable time step methods)
%INPUTS:
