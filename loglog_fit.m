% Orion template code, not written by me
...
%   filter_params (optional): a struct with parameters to set the 
%       range of data points that should be included in the regression
